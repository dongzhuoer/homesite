...
Gradually, I get into wasting more time than what it promises to save ^[To make it worse, many times it doesn't work so I can't save any time]. In fact, the `Show in new windows` in RStudido Viewer panel is already handy enough.
